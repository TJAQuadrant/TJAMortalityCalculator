...
st.markdown(
    ...
    <style>
        ...
        /* --- Input system: remove Streamlit chrome, brighten text --- */
        ...
        input::placeholder, textarea::placeholder {
            ...
            -webkit-text-fill-color: #94a8c4 !important;
            opacity: 1 !important;
        }
        ...
        .section-copy, .threshold-sub, .hero-copy, .empty-copy, .footer {
