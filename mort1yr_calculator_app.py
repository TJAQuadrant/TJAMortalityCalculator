...
with col_form:
    ...
    st.markdown("<div class='section-title' style='font-size:1.12rem;'>Vitals</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='section-title' style='font-size:1.12rem;'>Preoperative labs</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='section-title' style='font-size:1.12rem;'>Comorbidities</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='section-title' style='font-size:1.12rem;'>Healthcare utilization</div>", unsafe_allow_html=True)
    ...
    with st.expander("Model diagnostics and deployment notes"):
        st.markdown(
            ...
            <div class="metric-grid">
              ...
              <div class="metric"><div class="metric-label">Features</div><div class="metric-value">43</div></div>
            </div>
            """,
            unsafe_allow_html=True,
        )
